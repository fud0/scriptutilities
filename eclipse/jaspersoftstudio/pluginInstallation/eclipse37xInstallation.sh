...
source pluginInstallCommand.sh $ECLIPSE370_FOLDER $ECLIPSE370_TARGZ $INDIGO_UPDATESITE_1 $INDIGO_UPDATESITE_2 
source pluginInstallCommand.sh $ECLIPSE371_FOLDER $ECLIPSE371_TARGZ $INDIGO_UPDATESITE_1 $INDIGO_UPDATESITE_2 
source pluginInstallCommand.sh $ECLIPSE372_FOLDER $ECLIPSE372_TARGZ $INDIGO_UPDATESITE_1 $INDIGO_UPDATESITE_2