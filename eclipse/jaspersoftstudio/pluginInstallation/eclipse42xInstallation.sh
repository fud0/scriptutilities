...
source pluginInstallCommand.sh $ECLIPSE420_FOLDER $ECLIPSE420_TARGZ $JUNO42_UPDATESITE_1 $JUNO42_UPDATESITE_2 
source pluginInstallCommand.sh $ECLIPSE421_FOLDER $ECLIPSE421_TARGZ $JUNO42_UPDATESITE_1 $JUNO42_UPDATESITE_2 
source pluginInstallCommand.sh $ECLIPSE422_FOLDER $ECLIPSE422_TARGZ $JUNO42_UPDATESITE_1 $JUNO42_UPDATESITE_2