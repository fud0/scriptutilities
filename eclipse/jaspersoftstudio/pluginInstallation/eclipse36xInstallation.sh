...
source pluginInstallCommand.sh $ECLIPSE360_FOLDER $ECLIPSE360_TARGZ $HELIOS_UPDATESITE_1 $HELIOS_UPDATESITE_2 
source pluginInstallCommand.sh $ECLIPSE361_FOLDER $ECLIPSE361_TARGZ $HELIOS_UPDATESITE_1 $HELIOS_UPDATESITE_2 
source pluginInstallCommand.sh $ECLIPSE362_FOLDER $ECLIPSE362_TARGZ $HELIOS_UPDATESITE_1 $HELIOS_UPDATESITE_2