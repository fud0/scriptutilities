...
source pluginInstallCommand.sh $ECLIPSE430_FOLDER $ECLIPSE430_TARGZ $KEPLER_UPDATESITE_1 $KEPLER_UPDATESITE_2 
source pluginInstallCommand.sh $ECLIPSE431_FOLDER $ECLIPSE431_TARGZ $KEPLER_UPDATESITE_1 $KEPLER_UPDATESITE_2 
#source pluginInstallCommand.sh $ECLIPSE432_FOLDER $ECLIPSE432_TARGZ $KEPLER_UPDATESITE_1 $KEPLER_UPDATESITE_2