...
source $BASE_SCRIPTS_LOCATION/pluginInstallCommand.sh $ECLIPSE380_FOLDER $ECLIPSE380_TARGZ $JUNO38_UPDATESITE_1 $JUNO38_UPDATESITE_2 
source $BASE_SCRIPTS_LOCATION/pluginInstallCommand.sh $ECLIPSE381_FOLDER $ECLIPSE381_TARGZ $JUNO38_UPDATESITE_1 $JUNO38_UPDATESITE_2 
source $BASE_SCRIPTS_LOCATION/pluginInstallCommand.sh $ECLIPSE382_FOLDER $ECLIPSE382_TARGZ $JUNO38_UPDATESITE_1 $JUNO38_UPDATESITE_2